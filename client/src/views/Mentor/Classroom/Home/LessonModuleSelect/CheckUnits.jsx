...
export default function CheckUnits(props) {
  ...
  const getOptions = (value) => plainOptions.find((option) => option.number === parseInt(value));
  ...
  return (
    <>
      ...
      <br />
      <CheckboxGroup
        options={plainOptions.map((option) => ({ label: `Unit ${option.number}`, value: option.number }))}
